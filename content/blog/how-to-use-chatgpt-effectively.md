...
tags: ["chatgpt", "ai tools", "productivity", "beginners"]
---
...
1. **Tell it who you are.** Add one sentence of personal context at the start of any new conversation: "I'm a [role] working on [thing], audience is [who]." Instant improvement.

2. **Ask for options, not the answer.** Instead of "write me a headline," say "give me 5 different headlines with different emotional angles." Then pick the best.

3. **Use the Custom Instructions.** In ChatGPT settings, add background about yourself that applies to every conversation. This removes the need to re-introduce yourself every time.
