...
tags: ["claude ai", "ai tools", "beginner guide", "ai prompting"]
---
...
**Prompt template:**
"Write a [type of document] for [recipient]. The key points are [list]. Tone: [professional/friendly/apologetic]. Length: [word count]."

**Example:**
"Write a three-paragraph email to a client apologizing for a missed deadline, explaining what went wrong, and proposing next steps. The project is a website redesign. Tone: sincere, not defensive."
...
**Example prompt:**
"I'm considering two job offers. Option A: bigger company, more structured, $120k/year. Option B: startup, more autonomy, $95k but equity. I value learning and growth but also stability. Walk me through the trade-offs for someone in my position."
...
**Example prompt:**
"Explain how transformer neural networks work in AI models. I have a technical background but I'm new to AI. Use an analogy if helpful. Aim for 300 words."
...
[Get the Complete Claude AI Guide for $17 →](https://cleoops.com)
