    ...
    <div className="min-h-screen bg-[#f8f9fc]">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        <div className="bg-white border border-[#e2e8f0] rounded-2xl p-8 prose prose-slate max-w-none">
          ...
          <p>This disclaimer is governed by and construed in accordance with the laws of the State of California, United States, without regard to its conflict of law provisions. Any disputes arising in connection with this disclaimer shall be subject to the exclusive jurisdiction of the state and federal courts located in Los Angeles County, California.</p>
